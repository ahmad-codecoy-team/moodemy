...
import { updateContentByDocName } from "../content/home-screen/actions";

interface AboutUsEditorProps {
  initialContent: Content | null;
}

export function AboutUsEditor({ initialContent }: AboutUsEditorProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await updateContentByDocName("about_us", {
        title,
        content,
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>About us content not found</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>About Us Content</CardTitle>
        <CardDescription>
          Manage your application's about us information
        </CardDescription>
      </CardHeader>

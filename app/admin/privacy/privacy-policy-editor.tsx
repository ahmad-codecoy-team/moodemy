...
export function PrivacyPolicyEditor({ initialContent }: PrivacyPolicyEditorProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await updateContentByDocName('privacy_policy', {
        title,
        content,
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Privacy policy content not found</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Privacy Policy Content</CardTitle>
        <CardDescription>
          Manage your privacy policy content and terms
        </CardDescription>
      </CardHeader>

...
export function LoginMessageEditor({
  initialContent,
}: LoginMessageEditorProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await updateContentByDocName("login_message", {
  ...
  if (!initialContent) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Login Message Content</CardTitle>
          <CardDescription>Login message content not found</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Login Message Content</CardTitle>
        <CardDescription>
          Manage the message shown to users during the login process
        </CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Textarea
                ...
                placeholder="Enter your login message..."
                rows={4}
                className="mt-1"
              />
            </div>

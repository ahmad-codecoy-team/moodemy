...
export function SplashScreenEditor({ initialContent }: SplashScreenEditorProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await updateContentByDocName('splash_screen', {
        title,
        content,
  ...
  if (!initialContent) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Splash Screen Content</CardTitle>
          <CardDescription>Splash screen content not found</CardDescription>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Splash Screen Content</CardTitle>
        <CardDescription>
          Manage the welcome message shown when users first open your app
        </CardDescription>
      </CardHeader>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Enter your splash screen content..."
                rows={6}
                className="mt-1"
              />
            </div>
